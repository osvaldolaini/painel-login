            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-11 col-md-10 col-sm-10">
                        ...
                        <input class="form-control" data-name="Nome do parceiro" placeholder="Nome do parceiro" value="{{ old('title', $data->title ?? '') }}" name="title" required="">
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <label for="nome">Imagem (ideal 120 x 120 pixels) </label>
                                            ...
                                            <div class="image barra complete">
                                                ...
                                                <div class="text">
                                                    <div>
                                                        ...
                                                        <a style="cursor:pointer;color: #fff;" data-path="{{url('storage/images/partners/'.$data->id)}}" data-image="{{$data->image}}" class="btn btn-info py-0 text-white showImage">Visualizar <i class="fas fa-image" ></i></a>
