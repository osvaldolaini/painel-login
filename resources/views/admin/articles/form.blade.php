            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-11 col-md-10 col-sm-10">
                        ...
                        <input class="form-control" data-name="Título do artigo" placeholder="Título do artigo" value="{{ old('title', $data->title ?? '') }}" name="title" required="">
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <label for="files">Imagens (720 x 480)</label>
